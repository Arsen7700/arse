...
5. Откройте «Продажи → Отчёт для Telegram», введите `TELEGRAM_ADMIN_KEY`, выберите дату и нажмите «Отправить выбранный день сейчас». Для повтора не нужен повторный запуск приложения.
